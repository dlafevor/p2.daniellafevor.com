...
# What is the name of this app?
	define('APP_NAME', 'Backyard Barker -- Aliteration by Linda Curty');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'dlafevor@g.harvard.com'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'dlafevor@g.harvard.com'); 

# Default DB name for this app
	define('DB_NAME', 'p2_daniellafevor_com'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', '8e8bc28eacb81622534dea247ee959bbae535784');
	define('TOKEN_SALT', '97ea5a15f87918f0154b2b693f6986fd82cf1aa3');